...
export class AuthService {
  ...
  async externalLogin(dto: ExternalLoginDto) {
    ...
    let user = await this.usersService.findExternalByPhoneAndMerchant(externalPhone, merchant);
    if (!user) {
      user = await this.usersService.createExternalPlayer(externalPhone, merchant);
    }
